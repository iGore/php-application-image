...
cli-images:
	...
	docker buildx build --push --platform linux/arm/v7,linux/arm64/v8,linux/amd64 --tag patricksiemen/php-nginx-symfony:cli-8.1 --tag patricksiemen/php-nginx-symfony:cli-8 --tag patricksiemen/php-nginx-symfony:cli-latest --build-arg PHP_VERSION=8.1 cli
...
web-images:
	...
	docker buildx build --push --platform linux/arm/v7,linux/arm64/v8,linux/amd64 --tag patricksiemen/php-nginx-symfony:web-8.1 --tag patricksiemen/php-nginx-symfony:web-8 --tag patricksiemen/php-nginx-symfony:web-latest --tag patricksiemen/php-nginx-symfony:latest --build-arg PHP_VERSION=8.1 web
...
#	no 7.1 since xdebug requires at least 7.2!
	...
	docker buildx build --push --platform linux/arm/v7,linux/arm64/v8,linux/amd64 --tag patricksiemen/php-nginx-symfony:web-8.1-dev --tag patricksiemen/php-nginx-symfony:web-8-dev --tag patricksiemen/php-nginx-symfony:web-latest-dev --build-arg PHP_VERSION=8.1 web-dev
